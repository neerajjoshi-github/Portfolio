...
const ProjectCard: FC<ProjectCardProps> = ({ data }) => {
  return (
    <div className="max-w-[1080px] group md:ml-20 mt-10 min-h-[350px] flex flex-col md:flex-row items-center bg-slate-800/50 px-4 pb-8 pt-4 rounded-lg">
